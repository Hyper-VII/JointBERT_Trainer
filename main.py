...
from utils import load_tokenizer, MODEL_CLASSES, MODEL_PATH_MAP, init_logger, set_seed
...
if __name__ == '__main__':
    ...
    parser.add_argument("--domain_label_file", default="", type=str, help="Domain Label file")
